...
const { CSSStyleDeclaration, parseStyleSheet } = require("css-object-model");
...
const defaultStyleSheet = parseStyleSheet(require("./default-stylesheet"));
...
function Window(options) {
  ...
  this.getComputedStyle = function (node) {
    ...
    const s = node.style;
    const cs = CSSStyleDeclaration.create();
